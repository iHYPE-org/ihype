const _ChC = {
  ac:'#ff5029', ink:'#eef1f6', ink2:'#96a1b5', ink3:'#8792a6',
  bg:'#18233a', line:'rgba(255,255,255,.06)', line2:'rgba(255,255,255,.14)',
...
export function Checkbox({ checked, onChange, label, detail, disabled, accent = '#ff5029' }) {
  return React.createElement('label', {
    ...
    React.createElement('div', {
      ...
      React.createElement('path', { d:'M5 12l4 4L19 7', stroke:'#0b1220', strokeWidth:'3', strokeLinecap:'round', strokeLinejoin:'round' })
    )),
