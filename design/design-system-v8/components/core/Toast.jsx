...
export function Toast({ message, detail, variant = 'info', onClose }) {
  ...
  React.createElement('div', { style: { flex: 1, minWidth: 0 } },
    React.createElement('div', { style: { fontSize: 13, fontWeight: 600, color: '#eef1f6', lineHeight: 1.3 } }, message),
    detail && React.createElement('div', { style: { fontSize: 12, color: '#96a1b5', marginTop: 3, lineHeight: 1.5 } }, detail)
  ),
  onClose && React.createElement('button', {
    onClick: onClose,
    style: { background: 'transparent', border: 'none', color: '#8792a6', cursor: 'pointer', padding: 0, display: 'flex', flexShrink: 0, marginTop: 2 },
