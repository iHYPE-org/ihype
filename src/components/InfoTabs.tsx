  ...
  return (
    <div className="legal-wrap">
      ...
      <div className={`legal-doc legal-doc-prose${tab === 'charter' ? ' active' : ''}`} role="tabpanel" id="legal-panel-charter" aria-labelledby="legal-tab-charter">
        ...
        <p>{t('legalPage.charter.lockedMeansBodyNever', 'iHYPE will never take anything from ticket sales — no percentage, no fee, no cut of any ticket. That promise is a condition of incorporation: changing it would require dissolving the company and re-incorporating under a different structure. No board vote, no shareholder approval, no acquisition clause overrides it.')}</p>
