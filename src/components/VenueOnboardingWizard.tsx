  ...
  return (
    <div className="von-page">
      ...
      <style>{`
        ...
        .von-eyebrow { font-family: var(--font-mono); font-size: 0.6875rem; letter-spacing: .14em; text-transform: uppercase; color: var(--ink-a65); margin-bottom: 10px; }
        ...
        .von-sub { font-size: 0.9375rem; color: var(--ink-a65); line-height: 1.65; margin: 0 0 24px; }
        .von-sub-center { max-width: 34ch; margin-left: auto; margin-right: auto; }
        .von-proof-hint { font-size: 0.9375rem; color: var(--ink-a65); line-height: 1.55; margin: -4px 0 16px; }
        .von-label { display: block; font-family: var(--font-mono); font-size: 0.9375rem; letter-spacing: .08em; text-transform: uppercase; color: var(--ink-a65); margin: 0 0 6px; }
        ...
        .von-empty-text { font-size: 0.9375rem; color: var(--ink-a65); line-height: 1.5; }
        ...
        .von-badge { display: inline-flex; align-items: center; justify-content: center; font-family: var(--font-mono); font-size: 0.9375rem; letter-spacing: .06em; padding: 5px 14px; border-radius: var(--radius-pill); background: rgba(var(--role-venue-rgb),.15); color: var(--role-venue); margin-bottom: 8px; }
      `}</style>
    </div>
  );
}
