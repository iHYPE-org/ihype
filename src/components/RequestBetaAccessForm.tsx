...
export function RequestBetaAccessForm({ role, defaultOpen = false }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="beta-access-panel">
      ...
      <style>{`
        .beta-access-toggle { background: none; border: none; padding: 0; color: var(--ink-2); font-family: var(--font-mono); font-size: 0.7813rem; text-decoration: underline; cursor: pointer; }
        ...
        .beta-access-label { font-family: var(--font-mono); font-size: 0.7813rem; letter-spacing: .08em; text-transform: uppercase; color: var(--ink-3); }
