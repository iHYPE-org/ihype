  ...
  return (
    <section className="money-terms" aria-labelledby="money-terms-title">
      ...
      <ul className="money-terms-list">
        ...
        <li>{t('moneyTerms.taxEstimate', 'The tax iHYPE adds at checkout is an estimate from the buyer’s and the venue’s location. The venue is responsible for confirming the correct rate for its area.')}</li>
