  ...
  return (
    <div className="connect-payout-panel">
      ...
      <style>{`
        ...
        .connect-payout-badge { display: inline-flex; align-items: center; gap: 8px; font-family: var(--font-mono); font-size: 0.9375rem; letter-spacing: .08em; text-transform: uppercase; }
        ...
        .connect-payout-copy { font-size: 0.9375rem; color: var(--ink-2); line-height: 1.5; margin: 8px 0 0; }
        .connect-payout-btn { align-self: flex-start; background: var(--accent); color: var(--ink-on-accent); border: none; border-radius: 8px; padding: 10px 20px; font-family: var(--font-display); font-weight: 700; font-size: 0.9375rem; cursor: pointer; }
        .connect-payout-btn:disabled { opacity: .6; cursor: default; }
        .connect-payout-error { font-size: 0.9375rem; color: var(--accent-text); margin: 0; }
      `}</style>
    </div>
  );
}
