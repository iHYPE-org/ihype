  ...
  return (
    <div className="connect-payout-panel">
      ...
      <style>{`
        ...
        .connect-payout-badge { display: inline-flex; align-items: center; gap: 8px; font-family: var(--font-mono); font-size: 0.7813rem; letter-spacing: .08em; text-transform: uppercase; }
