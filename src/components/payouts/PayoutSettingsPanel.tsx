  ...
  return (
    <div className="pset-panel">
      ...
      <style>{`
        ...
        .pset-sub { font-size: 0.875rem; color: var(--ink-a65); margin: 0 0 28px; }
        .pset-warn { padding: 14px 16px; border-radius: var(--radius-md); border: 1px solid var(--line); background: var(--bg2); color: var(--ink-a70); font-size: 0.8125rem; margin-bottom: 24px; }
        ...
        .pset-role { font-size: 0.7813rem; color: var(--ink-a65); margin-top: 2px; }
        .pset-role a { color: var(--ink-a65); }
        .pset-pill { flex-shrink: 0; font-family: var(--font-mono); font-size: 0.7813rem; text-transform: uppercase; letter-spacing: .1em; padding: 5px 10px; border-radius: var(--radius-pill); }
        ...
        .pset-account-label { font-size: 0.875rem; font-weight: 500; color: var(--ink); }
        .pset-account-id { font-family: var(--font-mono); font-size: 0.7813rem; color: var(--ink-a65); margin-top: 3px; }
        .pset-note { padding: 14px 16px; border-radius: var(--radius-md); border: 1px solid var(--line); background: var(--bg2); margin-bottom: 0; }
        .pset-note-label { font-family: var(--font-mono); font-size: 0.7813rem; letter-spacing: .08em; text-transform: uppercase; color: var(--ink-a65); margin-bottom: 4px; }
        .pset-note p { font-size: 0.7813rem; color: var(--ink-a65); line-height: 1.6; margin: 0; }
      `}</style>
    </div>
  );
}
