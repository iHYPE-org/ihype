  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .lsr-btn { font-family: var(--font-mono); font-size: 0.9375rem; text-transform: uppercase; letter-spacing: .06em; padding: 11px 20px; border-radius: var(--radius-pill); border: none; cursor: pointer; }
