    ...
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px,1fr))', gap: 14, marginBottom: 40 }}>
        <Link href="/tickets" style={quickCardStyle}>
          ...
          <div style={{ fontSize: '0.9375rem', fontFamily: 'var(--font-display)', fontWeight: 800, marginBottom: 4 }}>{t('supportPageClient.myTickets', 'My Tickets')}</div>
          <div style={{ fontSize: '0.9375rem', color: 'var(--ink-a65)' }}>{t('supportPageClient.myTicketsDescription', 'Transfer, share, or get a QR code')}</div>
        </Link>
