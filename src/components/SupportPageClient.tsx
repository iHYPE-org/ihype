    ...
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px,1fr))', gap: 14, marginBottom: 40 }}>
        <Link href="/tickets" style={quickCardStyle}>
          ...
          <div style={{ fontSize: 12, color: 'rgba(240,235,229,.55)' }}>Transfer, share, or get a QR code</div>
        </Link>
      ...
      <div
        ref={formRef}
        style={{ border: '1px solid rgba(255,255,255,.06)', borderRadius: 12, padding: 32, background: 'var(--bg-2, #100d09)' }}
      >
