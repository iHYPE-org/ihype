  ...
  return (
    <div className="lp-wrap">
      <section className="lp-hero" style={{ paddingBottom: '20px' }}>
        ...
        <h2 className="lp-hero-h" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>{t('transparencyPage.heroTitle', 'Transparency report')}</h2>
        ...
        <div className="lp-reason-grid" style={{ marginTop: '20px' }}>
          {[
            ...
            },
            {
              ...
              /* This promised free hosting for "all hosts … every DJ and
                 promoter", on the page whose whole subject is telling the
                 truth about the money (2026-09-11). It named two things the
                 product does not have — a DJ role, deleted 2026-08-06, and
                 member hosting, removed with it. The claim underneath (no
                 tier, no paid placement) is true of the station that does
                 exist, so it is made about that. */
