...
function FullPlayerImpl({
  ...
  const round = (glyph, label, onClick, size, tone) => React.createElement('button', {
    ...
    style: {
      ...
      fontSize: dsFontSize('var(--text-lg)'), cursor: 'pointer',
    },
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), letterSpacing: 'var(--tracking-widest)', textTransform: 'uppercase', color: _FP.ink3, textAlign: 'center' },
      ...
      React.createElement('div', {
        ...
        style: {
          ...
          fontFamily: _FP.fd, fontWeight: 400, fontSize: dsFontSize('var(--text-3xl)'), letterSpacing: 'var(--tracking-normal)',
      ...
      React.createElement('div', { style: { textAlign: 'center', marginTop: 'var(--space-5)' } },
        React.createElement('div', {
          style: { fontFamily: _FP.fd, fontWeight: 400, fontSize: dsFontSize('var(--text-xl)'), letterSpacing: 'var(--tracking-normal)', lineHeight: 'var(--leading-heading)' },
        }, track.title),
        React.createElement('div', {
          style: { display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 'var(--space-1)', marginTop: 'var(--space-1)', fontSize: dsFontSize('var(--text-base)'), color: _FP.ink2 },
        },
      ...
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 'var(--space-3)', marginTop: 'var(--space-5)' } },
        React.createElement('span', { style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), color: _FP.ink3, minWidth: 34 } }, clock(progress, track.seconds)),
        bar({ value: progress, onSeek, label: 'Seek' }),
        React.createElement('span', { style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), color: _FP.ink3, minWidth: 34, textAlign: 'right' } }, clock(100, track.seconds))
      ),
      ...
      React.createElement('div', {
        ...
        React.createElement('button', {
          ...
          style: {
            ...
            fontSize: dsFontSize('var(--text-lg)'), paddingLeft: playing ? 0 : 5,
      ...
      React.createElement('div', {
        ...
        React.createElement('button', {
          ...
          React.createElement('span', {
            style: { fontFamily: _FP.fd, fontWeight: 400, fontSize: dsFontSize('var(--text-base)'), letterSpacing: 'var(--tracking-wide)' },
          }, 'HYPE'),
          hypeLocked && hypeLabel ? React.createElement('span', {
            style: { fontFamily: _FP.fm, fontWeight: 500, fontSize: dsFontSize('var(--text-xs)'), opacity: .85 },
          }, hypeLabel) : null
        ),
      ...
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 'var(--space-3)', marginTop: 'var(--space-5)' } },
        React.createElement('span', { 'aria-hidden': 'true', style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), color: _FP.ink3 } }, '\u266b'),
        bar({ value: volume, onSeek: onVolume, label: 'Volume', accent: false, height: 4 }),
        React.createElement('span', { style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), color: _FP.ink3, minWidth: 30, textAlign: 'right' } }, Math.round(volume) + '%')
      ),

      queue.length ? React.createElement('div', { style: { marginTop: 'var(--space-6)' } },
        React.createElement('div', {
          style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), letterSpacing: 'var(--tracking-wider)', textTransform: 'uppercase', color: _FP.ink3, marginBottom: 'var(--space-2)' },
        }, 'Up next'),
        queue.map((t, i) => React.createElement('button', {
          ...
          React.createElement('span', { style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), color: _FP.ink3, width: 20, flex: '0 0 auto' } }, String(i + 1).padStart(2, '0')),
          React.createElement('span', { style: { flex: 1, minWidth: 0, fontSize: dsFontSize('var(--text-base)'), color: _FP.ink, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' } }, t.title),
          React.createElement('span', { style: { fontSize: dsFontSize('var(--text-base)'), color: _FP.ink2, flex: '0 0 auto' } }, t.artist)
        ))
      ) : null,
      ...
      history.length ? React.createElement('div', { style: { marginTop: 'var(--space-5)', borderTop: '1px solid ' + _FP.line, paddingTop: 'var(--space-4)' } },
        ...
        history.map((t, i) => React.createElement('button', {
          ...
          React.createElement('span', { style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), color: _FP.ink3, width: 20, flex: '0 0 auto' } }, '\u00b7'),
          React.createElement('span', { style: { flex: 1, minWidth: 0, fontSize: dsFontSize('var(--text-base)'), color: _FP.ink2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' } }, t.title),
          React.createElement('span', { style: { fontSize: dsFontSize('var(--text-base)'), color: _FP.ink3, flex: '0 0 auto' } }, t.artist)
        ))
      ) : null,
    ...
    React.createElement('div', {
      ...
      React.createElement('button', {
        ...
        style: { display: 'flex', alignItems: 'center', fontFamily: _FP.fd, fontWeight: 400, fontSize: dsFontSize('var(--text-base)'), letterSpacing: 'var(--tracking-normal)', lineHeight: 1 },
      },
        'iH',
      ...
      React.createElement('span', {
        style: { fontFamily: _FP.fm, fontSize: dsFontSize('var(--text-xs)'), letterSpacing: 'var(--tracking-wider)', textTransform: 'uppercase', color: _FP.ink3 },
      }, 'Back')
    )
  );
}
