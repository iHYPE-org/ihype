    ...
    <>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '32px 24px 100px' }}>
        ...
        <div style={{ background: 'linear-gradient(140deg,rgba(var(--accent-rgb),.15),rgba(var(--role-venue-rgb),.08))', border: '1px solid rgba(var(--accent-rgb),.2)', borderRadius: 16, padding: 36, marginBottom: 40 }}>
          ...
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'center', marginBottom: 20, fontSize: '0.9375rem', color: 'var(--ink-a75)' }}>
          ...
          {show.status === 'CANCELED' && (show.cancellationReason || show.cancellationMessage) && (
            <div style={{ marginBottom: 20, padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(var(--accent-rgb),.25)', background: 'rgba(var(--accent-rgb),.06)' }}>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.9375rem', letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--accent-text)', marginBottom: 6 }}>
                {t('showsSlugPage.canceledLabel', 'Event cancelled')}
                {show.cancellationReason ? ` · ${show.cancellationReason}` : ''}
              </div>
              {show.cancellationMessage && (
                <p style={{ fontSize: '0.9375rem', color: 'var(--ink-a75)', lineHeight: 1.6, margin: 0, whiteSpace: 'pre-wrap' }}>
                  {show.cancellationMessage}
                </p>
              )}
            </div>
                  ...
                  <div style={{ marginTop: 24 }}>
                    ...
                    {venueComps.map((vc) => (
                      <div key={vc.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderTop: '1px solid var(--hair-80)' }}>
                        <span style={{ flex: 1, fontSize: '0.9375rem', color: 'var(--ink-a85)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{vc.title}</span>
            ...
            {isShowOwner || isAdminSession(session) ? (
              <div className="panel" style={{ padding: '1.25rem', marginTop: 24 }}>
                ...
                <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid var(--hair-80)', display: 'flex', gap: 20, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  />
                  <div>
                    <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.9375rem', textTransform: 'uppercase', letterSpacing: '.1em', color: 'var(--ink-a65)', marginBottom: 4 }}>
            ...
            <aside style={{ border: '1px solid var(--hair-80)', borderRadius: 12, padding: 28, background: 'var(--bg2)', position: 'sticky', top: 80, alignSelf: 'flex-start' }}>
              ...
              {cap !== null && (
                <>
                  ...
                  <div style={{ fontSize: '0.9375rem', color: 'var(--ink-a65)', marginBottom: 16 }}>{sold} / {cap} {t('showsSlugPage.soldLabel', 'sold')} · {cap - sold} {t('showsSlugPage.remainingLabel', 'remaining')}</div>
                </>
              )}

              <div style={{ marginBottom: 18 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 6 }}>
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.9375rem', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--ink-a65)' }}>{t('showsSlugPage.demandLast12h', 'Demand — last 12h')}</span>
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.9375rem', color: demandLabelColor }}>
              ...
              {!isPaymentProcessingConfigured() ? (
                <div style={{ border: '1px solid rgba(var(--role-venue-rgb),.3)', borderRadius: 10, padding: 16, background: 'rgba(var(--role-venue-rgb),.06)' }}>
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6875rem', textTransform: 'uppercase', letterSpacing: '.14em', color: 'var(--role-venue)', marginBottom: 8 }}>
