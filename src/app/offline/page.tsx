  ...
  return (
    <div className="offline-body">
      ...
      <style>{`
        ...
        .offline-sub { font-size: 15px; color: rgba(240,235,229,.6); text-align: center; max-width: 380px; line-height: 1.6; margin-bottom: 48px; }
        .offline-code { font-family: var(--font-mono); font-size: 11px; letter-spacing: .14em; text-transform: uppercase; color: rgba(240,235,229,.3); margin-bottom: 48px; }
        ...
        .offline-btn-ghost { padding: 13px; background: transparent; color: rgba(240,235,229,.6); border: 1px solid rgba(255,255,255,.1); border-radius: 10px; font-family: var(--font-body); font-size: 14px; cursor: pointer; transition: all 150ms; text-align: center; text-decoration: none; display: block; }
        .offline-btn-ghost:hover { background: rgba(255,255,255,.04); color: var(--ink); }
        .offline-status-bar { position: fixed; bottom: 0; left: 0; right: 0; height: 3px; background: rgba(255,255,255,.06); overflow: hidden; }
        .offline-status-fill { height: 100%; width: 0%; background: var(--accent); }
        .offline-retry-msg { font-family: var(--font-mono); font-size: 10px; letter-spacing: .12em; text-transform: uppercase; color: rgba(240,235,229,.3); margin-top: 32px; min-height: 16px; }
      `}</style>
    </div>
  );
}
