  ...
  return (
    <div className="container" style={{ paddingTop: 24, paddingBottom: 60 }}>
      ...
      <div className="callout warning" style={{ maxWidth: 600 }}>
        <p>Rate limit data is stored in Cloudflare KV. To see which endpoints are hitting limits most:</p>
        <ol>
          <li>Check Cloudflare dashboard → Workers KV for keys prefixed with <code>rl:</code></li>
