...
.foryou-title { font-family: var(--font-display); font-weight: 800; font-size: 34px; line-height: 1.0; letter-spacing: -0.03em; color: var(--ink); margin: 10px 0 10px; }
.foryou-sub { font-family: var(--font-body); font-size: 15px; line-height: 1.6; color: var(--ink-a60); max-width: 54ch; margin: 0 0 24px; }
...
.foryou-name { font-family: var(--font-body); font-weight: 600; font-size: 16px; color: var(--ink); display: flex; align-items: center; gap: 6px; }
.foryou-verified { color: var(--role-venue); font-size: 12px; }
.foryou-meta { font-family: var(--font-body); font-size: 13px; color: var(--ink-a50); margin-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.foryou-empty p { font-family: var(--font-body); color: var(--ink-a60); margin: 0 0 14px; }
.foryou-cta { display: inline-block; font-family: var(--font-body); font-weight: 600; font-size: 15px; padding: 12px 22px; border-radius: 9999px; background: var(--accent-grad-warm); color: var(--ink-on-accent); text-decoration: none; }
.foryou-foot { font-family: var(--font-body); font-size: 14px; color: var(--ink-a50); text-align: center; margin-top: 24px; }
