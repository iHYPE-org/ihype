...
.foryou-card { background: #100d09; border: 1px solid var(--line); border-radius: 16px; }
...
.foryou-empty { text-align: center; padding: 32px; background: #100d09; border: 1px solid var(--line); border-radius: 16px; }
