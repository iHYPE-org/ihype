...
.station-page-title { font-family: var(--font-display); font-weight: 800; font-size: 34px; line-height: 1.0; letter-spacing: -0.03em; color: var(--ink); margin: 10px 0 12px; }
.station-page-sub { font-family: var(--font-body); font-size: 15px; line-height: 1.6; color: var(--ink-a60); max-width: 52ch; margin: 0 0 28px; }
.station-page-foot { font-family: var(--font-body); font-size: 13px; color: var(--ink-a45); margin-top: 24px; }
