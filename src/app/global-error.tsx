  ...
  return (
    <html>
      <body style={{
        ...
        <p style={{ fontSize: '0.9375rem', color: 'rgba(238,241,246,.6)', maxWidth: 380, lineHeight: 1.6, margin: '0 0 24px' }}>
        ...
        <button
          onClick={reset}
          style={{ padding: '14px 28px', background: 'var(--accent)', color: 'var(--ink-on-accent)', border: 'none', borderRadius: 10, fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: '1rem', fontWeight: 800, cursor: 'pointer' }}
        >
