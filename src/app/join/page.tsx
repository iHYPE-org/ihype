  ...
  return (
    <div className="join-wrap">
      ...
      <style>{`
        ...
        .join-skip { align-items: center; display: inline-flex; min-height: 44px; font-family: var(--font-mono); font-size: 0.9375rem; color: var(--ink-a65); text-decoration: underline; }
