  ...
  return (
    <div style={{ display: 'grid', placeItems: 'start center', padding: '32px 16px 80px' }}>
      ...
      <style>{`
        ...
        .cover-slot { width: 100%; height: 140px; margin-bottom: 20px; border-radius: 12px; background: var(--bg2); border: 1px dashed var(--hair-100); display: flex; align-items: center; justify-content: center; color: var(--ink-3); font-family: var(--font-mono); font-size: 0.7813rem; letter-spacing: .1em; text-transform: uppercase; }
      `}</style>
    </div>
  );
}
