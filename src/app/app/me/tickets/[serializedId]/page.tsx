          ...
          <div className="ticket-verification-copy">
            ...
            <div className="cta-row">
              {ticket.show.venueProfile ? (
                <Link className="button small secondary" href={`/app/venues/${ticket.show.venueProfile.slug}`}>
                  {t('ticketsSerializedIdPage.openVenue', 'Open venue')}
                </Link>
              ) : null}
              <Link className="button small secondary" href={`/app/shows/${ticket.show.slug}`}>
