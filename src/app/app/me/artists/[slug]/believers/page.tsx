...
.believers-eyebrow { font-family: 'JetBrains Mono', monospace; font-size: 0.6875rem; letter-spacing: 0.16em; color: var(--accent-text); }
...
.believers-sub { font-family: 'Work Sans', sans-serif; font-size: 0.9375rem; line-height: 1.5; color: var(--ink-a65); margin: 0 0 24px; }
...
.believers-you-text span { font-family: 'Work Sans', sans-serif; font-size: 0.9375rem; color: var(--ink-a65); }
.believers-share-btn, .believers-cta { flex-shrink: 0; font-family: 'Work Sans', sans-serif; font-weight: 600; font-size: 0.9375rem; padding: 10px 18px; border-radius: 9999px; border: none; cursor: pointer; background: var(--accent-grad-warm); color: var(--ink-on-accent); text-decoration: none; }
.believers-cta-card span { flex: 1; font-family: 'Work Sans', sans-serif; font-size: 0.9375rem; color: var(--ink-a70); }
...
.believers-you-tag { font-family: 'JetBrains Mono', monospace; font-size: 0.9375rem; letter-spacing: 0.1em; color: var(--accent-text); background: rgba(var(--accent-rgb),0.14); border-radius: 4px; padding: 2px 6px; }
.believers-early-tag { font-family: 'JetBrains Mono', monospace; font-size: 0.9375rem; letter-spacing: 0.1em; color: var(--role-fan); background: rgba(var(--role-fan-rgb),0.12); border-radius: 4px; padding: 3px 7px; }
`;
