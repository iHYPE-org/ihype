  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#f0f0f0', fontFamily: 'system-ui, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 24px' }}>
      <div style={{ maxWidth: 560, width: '100%' }}>
        <div style={{ fontFamily: 'monospace', fontSize: 11, letterSpacing: '.2em', color: '#ff5029', marginBottom: 16 }}>{t('auxQueueSlugPage.eyebrow', '● IHYPE · PASSED THE AUX')}</div>
        ...
        <div style={{ marginTop: 40, textAlign: 'center' }}>
          <a href="https://ihype.org" style={{ color: '#ff5029', fontSize: 13, textDecoration: 'none' }}>{t('auxQueueSlugPage.discoverMoreLink', 'Discover more on iHYPE →')}</a>
        </div>
      </div>
    </div>
  );
