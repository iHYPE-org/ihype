...
export default async function InviteLandingPage({ params }: Props) {
  ...
  return (
    <div style={{ maxWidth: 480, margin: '80px auto', padding: '0 24px', textAlign: 'center' }}>
      <p style={{ fontFamily: 'var(--f-m)', fontSize: '0.9375rem', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--ink-3)', marginBottom: 8 }}>
      ...
      {profile?.headline ? (
        <p style={{ fontFamily: 'var(--f-m)', fontSize: '0.9375rem', color: 'var(--ink-2)', marginBottom: 24 }}>
          {profile.headline}
        </p>
      ) : (
        <p style={{ fontFamily: 'var(--f-m)', fontSize: '0.9375rem', color: 'var(--ink-2)', marginBottom: 24 }}>
      ...
      <p style={{ fontFamily: 'var(--f-m)', fontSize: '0.9375rem', color: 'var(--ink-3)' }}>
