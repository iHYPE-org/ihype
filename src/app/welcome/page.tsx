  ...
  return (
    <div className="welcome-body">
      ...
      <style>{`
        ...
        .welcome-h1 { font-family: var(--f-d); font-weight: 800; font-size: clamp(32px, 7vw, 48px); letter-spacing: -.04em; line-height: 1; color: var(--ink); }
        ...
        .welcome-avatar { width: 44px; height: 44px; border-radius: 50%; flex-shrink: 0; display: flex; align-items: center; justify-content: center; color: #fff; font-family: var(--f-d); font-weight: 800; }
        .welcome-name { font-family: var(--f-d); font-weight: 800; font-size: 16px; color: var(--ink); }
        ...
        .welcome-step-num { flex-shrink: 0; width: 24px; height: 24px; border-radius: 7px; background: rgba(var(--accent-rgb),.12); color: var(--accent); font-family: var(--f-d); font-weight: 800; font-size: 12px; display: flex; align-items: center; justify-content: center; }
        ...
        .welcome-cta { display: inline-block; margin-top: 28px; font-family: var(--f-d); font-weight: 800; font-size: 15px; background: var(--accent); color: var(--ink-on-accent); padding: 14px 34px; border-radius: 999px; box-shadow: 0 6px 24px rgba(var(--accent-rgb),.35); text-decoration: none; transition: opacity 150ms; }
