...
.booking-hype { font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.08em; text-transform: uppercase; color: var(--ink-a55); background: rgba(255,255,255,0.04); border-radius: 4px; padding: 3px 7px; }
