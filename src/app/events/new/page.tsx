    ...
    return (
      <div className="field">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', background: 'rgba(255,80,41,.07)', border: '1px solid rgba(255,80,41,.2)', borderRadius: 10 }}>
          ...
          <button onClick={() => onChange(null)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(240,235,229,.4)', fontSize: 18, lineHeight: 1, padding: '0 4px' }} type="button">×</button>
        </div>
      </div>
    );
  }
