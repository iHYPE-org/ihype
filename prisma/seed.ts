...
async function main() {
  ...
  const venue = await prisma.profile.upsert({
    ...
    update: {
      ...
      bio: 'Warehouse venue hosting underground sets every weekend.',
      ...
      requestContent: 'Recommend artists who can own a warehouse room, bring a real live concept, or fit a future headline bill.',
      ...
      upcomingContent: 'Upcoming nights lean toward warehouse live sets, high-energy headline rooms, and crossover bills that can turn hype into a packed floor.',
      previousShowHighlights: 'Past runs here have sold through late, stretched into sunrise, and turned smaller shows into repeat in-room bookings.',
  ...
  const chicagoVenue = await prisma.profile.upsert({
    ...
    update: {
      ...
      headline: 'Chicago open-air energy with enough room for a headline set and a neighborhood crowd.',
      bio: 'Chicago venue profile for riverfront sets, outdoor shows, and city-scale launch nights.',
      aboutContent: 'Lakefront Frequency is built for skyline energy, dance-floor airflow, and Chicago crowds that show up early when the right signal hits.',
      requestContent: 'Recommend artists who can hold an outdoor room, travel well across the Midwest, and convert crowd momentum into a real booking.',
      ...
      upcomingContent: 'The calendar is stacked with riverfront live sets, skyline nights, and Midwest crossover bills built for both locals and travelers.',
      previousShowHighlights: 'Previous nights here have mixed outdoor energy, hometown lineups, and big moments that translate well into ticket sales.',
  ...
  const liveShow = await prisma.show.upsert({
    ...
    update: {
      ...
      description: 'A live back-to-back warehouse set with audience hype.',
  ...
  const rooftopShow = await prisma.show.upsert({
    ...
    update: {
      ...
      description: 'Sunset live set from a downtown rooftop with guest artists.',
  ...
  const chicagoLiveShow = await prisma.show.upsert({
    ...
    update: {
      ...
      description: 'Chicago riverfront show with a hometown crowd and skyline energy.',
      status: ShowStatus.LIVE,
