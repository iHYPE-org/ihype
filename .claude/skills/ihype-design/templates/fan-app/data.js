...
window.IHYPE_DATA = {
  ...
  notifications: {
    ...
    artist: [
      ...
      { id: 'na3', icon: 'dollar', tone: '#22e5d4', title: 'Payout sent · $1,872', body: 'Your 70% from The Echo cleared.', when: '3d', unread: false },
    ],
    venue: [
      ...
      { id: 'nv3', icon: 'dollar', tone: '#22e5d4', title: 'Payout sent · $1,872', body: 'Your 70% from the Jun 20 show cleared.', when: '3d', unread: false },
    ],
    promoter: [
